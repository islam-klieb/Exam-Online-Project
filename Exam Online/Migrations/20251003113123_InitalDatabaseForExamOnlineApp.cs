...
{
    /// <inheritdoc />
    public partial class InitalDatabaseForExamOnlineApp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration = table.Column<int>(type: "int", nullable: false, comment: "Duration in minutes, min: 20, max: 180"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "newsequentialid()"),
                    TextChoice = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false),
                    ChoiceType = table.Column<int>(type: "int", nullable: true),
                    ChoiceFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
